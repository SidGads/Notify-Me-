...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String ACTION_UPDATE_NOTIFICATION ="com.example.android.notify-me.ACTION_UPDATE_NOTIFICATION";
    ...
    public void updateNotification() {
        ...
        Bitmap androidImage = BitmapFactory.decodeResource(getResources(),R.drawable.hawkeye);
        NotificationCompat.Builder notifyBuilder = getNotificationBuilder();
    ...
    private NotificationCompat.Builder getNotificationBuilder(){
        ...
        NotificationCompat.Builder notifyBuilder = new NotificationCompat.Builder(this, PRIMARY_CHANNEL_ID).setContentTitle("You've been notified!")
                .setContentText("This is your notification text.").setSmallIcon(R.drawable.ic_amdroid).setContentIntent(notificationPendingIntent).setAutoCancel(true)
